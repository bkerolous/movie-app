...
const Details = () => {
  ...
  if (isLoading) return <div className={`${style['spinner-wrap']}`}><ImSpinner6 className={`${style.spinner}`} /></div>;
            ...
            <div className={`${style['card-movie']}`}>
              ...
              <div className={`${style["card-details"]}`}>
                ...
                <p className="card-media_type">
                  <span className={`${style["text-size"]}`}>Media_type : </span>
                  {media_type}
                </p>
                <p className="card-overview">
                    <span className={`${style["text-size"]}`}>Over_View : </span>
                     {data?.overview}</p>
              </div>
            </div>
          </div>
